...
public class PersonalAdvantageActivity extends BaseActivity {
	...
	public void prepareViews() {
		txt_header.setText(R.string.cascade_personal_advantage);
...
//		settings.setJavaScriptEnabled(true);
	...
	private class CustomWebClient extends WebViewClient {
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			...
			try {
				progressDialog = new ProgressDialog(PersonalAdvantageActivity.this);
	...
	private class AsyncLifeAdvantagePageContent extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			mContext = PersonalAdvantageActivity.this;
		...
		protected void onPostExecute(Void result) {
			...
			webView.loadUrl(EAPConstants.URL_LIFE_ADVANTAGE);
		}
